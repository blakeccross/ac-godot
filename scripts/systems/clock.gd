...
func outdoor_light() -> Dictionary:
	...
	return {
		...
		## Indoor `Global_kankyo_set_room_prim` / window outdoor-view fills.
		"room": (a["room"] as Color).lerp(b["room"] as Color, t),
		"sun_dir": dirs["sun"],
		"moon_dir": dirs["moon"],
