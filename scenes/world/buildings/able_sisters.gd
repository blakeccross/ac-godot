...
## Able Sisters outdoor shell. Door verb is shop; enter loads `needlework`.

@export var occupant_id: StringName = &"able_sisters"
...
@export var visual_id: StringName = &"obj_s_tailor"
@export var label: String = "Able Sisters"
@export var door_verb: StringName = &"shop"
...
func _ready() -> void:
	...
	if door != null:
		...
		if "closed_notice" in door:
			door.set("closed_notice", "The shop is closed.")
