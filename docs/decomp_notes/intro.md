...
- Background sleep NPC at FG ut (4,4), birth offset x−6/z−24 → ~(174, 156) GX; `wait_nemu1` base + `kokkuri_d1`/`d2` nod. Bench align via lowest-vertex snap to ~40 GX cushion height.
