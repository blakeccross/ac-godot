...
- Modal text box with appear/disappear scale (18 decomp frames = 0.3 s at 60 Hz), typewriter (a glyph every other frame = 30/sec, 60 with fast text), A/E to continue, hold to speed up.
