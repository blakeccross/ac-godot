...
- **Save/load** of: clock, player position/scene, pockets + wallet, town name, FG deltas (trees/items, including stumps), villager friendship/schedule pointers, shop stock if present.
