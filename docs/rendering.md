...
- **Not targeting:** Compatibility (GL) or Mobile renderers. Do not rely on Compatibility-only features.
...
| Web, mobile, consoles | Not a goal |

Export presets do not require changing the renderer.
