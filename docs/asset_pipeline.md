...
- Audio (`audiorom.img`) is not converted yet. Plan: `--kind audio` renders sequences to gitignored OGG ([decomp_notes/audio.md](decomp_notes/audio.md)). Do not commit Nintendo music.
