...
- **Do:** Resource defaults, clock advancement, inventory stacking, shop prices, schedule lookups, save round-trips, grid cell math, locomotion accel/turn, interaction verb priority and host duck-typing.
