...
func test_species_codes_map_to_disc_prefixes() -> void:
	...
	assert_str(FieldCatalog.species_code(&"rcn")).is_equal("rcn")
	assert_str(FieldCatalog.species_code(&"rcc")).is_equal("rcc")
	assert_str(FieldCatalog.species_code(&"rcs")).is_equal("rcs")
	assert_str(FieldCatalog.species_code(&"rcd")).is_equal("rcd")
